...
import com.maoxin.apkshell.hook.Utils;
...
public class LoadedApkClassLoaderHookHelper {
    ...
    public static void hookLoadedApkInActivityThread(File apkFile) throws ClassNotFoundException, NoSuchMethodException,
        ...
        Class[] p1 = {ApplicationInfo.class, RefInvoke.getClassForName("android.content.res.CompatibilityInfo")};
     ...
     */
    public static ApplicationInfo generateApplicationInfo(File apkFile) throws ClassNotFoundException,
        ...
        Class<?> packageParserClass = RefInvoke.getClassForName("android.content.pm.PackageParser");
        Class<?> packageParser$PackageClass = RefInvoke.getClassForName("android.content.pm.PackageParser$Package");
        Class<?> packageUserStateClass = RefInvoke.getClassForName("android.content.pm.PackageUserState");
