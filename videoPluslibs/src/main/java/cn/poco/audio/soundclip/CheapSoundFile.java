...
//        Factory factory =  CheapWAV.getFactory();
    ...
    public static CheapSoundFile create(File file)
        throws java.io.FileNotFoundException,
               java.io.IOException {
        if (file == null) {
            throw new java.io.FileNotFoundException();
        }
        // TODO: 2017/3/2 0002 modify by menghd
...
//        Factory factory =  CheapMP3.getFactory();
        if (factory == null) {
            return null;
        }
        CheapSoundFile soundFile = factory.create();
    ...
    public static int secondsToFrames(CheapSoundFile soundFile ,double seconds) {
